# Treasurer + macro brake (Phase 4, SHADOW) - harvest_20260807_2130
...
- empirical mean win +0.510 / mean loss -0.461  (payoff ratio 1.11)
...
## Macro circuit brake
- rows where the macro brake WOULD have fired: 11 of 13753 (0.1%)  [VIX>= 32 or +20% spike]
