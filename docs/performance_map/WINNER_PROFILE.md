...
## Numbers
- live: [[strategies.WINNER_PROFILE.live.n_closed = 11]] closed, [[strategies.WINNER_PROFILE.live.per_trade = +21.1]] per trade,
  open [[strategies.WINNER_PROFILE.live.open = 5]].
