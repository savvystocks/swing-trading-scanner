...
OUT = "reports/research/spread_access_v2.jsonl"
QUAL_PREM = 50000.0
BUDGETS = [1000.0, 1600.0]   # v2 drops 2500 to keep the run bounded at the deeper sample
HORIZON = 21
STOP, TRIG, GIVE = -50.0, 50.0, 0.20
PER_DAY = 260        # v2: deep sample so the narrow cells (BULL_DIP, DIP_CONF_MILD) are measurable
SEED = 17
