# Treasurer + macro brake (Phase 4, SHADOW) - harvest_20260724_2130
...
- empirical mean win +0.516 / mean loss -0.453  (payoff ratio 1.14)
...
## Macro circuit brake
- rows where the macro brake WOULD have fired: 0 of 8653 (0.0%)  [VIX>= 32 or +20% spike]
