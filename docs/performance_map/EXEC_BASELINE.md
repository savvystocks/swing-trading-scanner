...
## Numbers
- live: [[strategies.EXEC_BASELINE.live.n_closed = 72]] closed, [[strategies.EXEC_BASELINE.live.per_trade = +8.7]] per trade,
  win [[strategies.EXEC_BASELINE.live.win = 44%]], best trade removed [[strategies.EXEC_BASELINE.live.best_removed_per_trade = +2.5]],
  day mean [[strategies.EXEC_BASELINE.live.unit_mean = +14.2]] over [[strategies.EXEC_BASELINE.live.units = 24]] days,
  halves [[strategies.EXEC_BASELINE.live.h1 = +24.1]] / [[strategies.EXEC_BASELINE.live.h2 = +4.4]], dollars [[strategies.EXEC_BASELINE.live.total_usd = +2,072]].
