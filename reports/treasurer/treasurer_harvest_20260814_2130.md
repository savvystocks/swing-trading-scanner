# Treasurer + macro brake (Phase 4, SHADOW) - harvest_20260814_2130
...
- empirical mean win +0.516 / mean loss -0.452  (payoff ratio 1.14)
...
## Macro circuit brake
- rows where the macro brake WOULD have fired: 264 of 16617 (1.6%)  [VIX>= 32 or +20% spike]
- shadow only: records would-have-braked; arms live only through LIVE_GATE + Governor.

- trials counted (council pass): {'council_features_clustered_out': 31, 'council_rule_folds': 5, 'council_member_fits': 25, 'TOTAL': 61}
