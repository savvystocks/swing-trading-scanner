...
## Numbers
- live: [[strategies.WINNER_PROFILE.live.n_closed = 7]] closed, [[strategies.WINNER_PROFILE.live.per_trade = -25.2]] per trade,
...
- archive (partial cell): [[strategies.WINNER_PROFILE.archive.per_day = -5.2]] per day (pool
  [[strategies.WINNER_PROFILE.archive.pool_per_day_same_days = -5.2]]), t vs pool [[strategies.WINNER_PROFILE.archive.t_vs_pool = -2.09]].
