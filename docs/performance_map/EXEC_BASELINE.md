...
## Numbers
- live: [[strategies.EXEC_BASELINE.live.n_closed = 74]] closed, [[strategies.EXEC_BASELINE.live.per_trade = +8.2]] per trade,
  win [[strategies.EXEC_BASELINE.live.win = 45%]], best trade removed [[strategies.EXEC_BASELINE.live.best_removed_per_trade = +2.2]],
  day mean [[strategies.EXEC_BASELINE.live.unit_mean = +10.9]] over [[strategies.EXEC_BASELINE.live.units = 24]] days,
  halves [[strategies.EXEC_BASELINE.live.h1 = +24.1]] / [[strategies.EXEC_BASELINE.live.h2 = -2.4]], dollars [[strategies.EXEC_BASELINE.live.total_usd = +2,193]].
