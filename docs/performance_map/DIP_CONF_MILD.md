...
- live: [[strategies.DIP_CONF_MILD.live.n_closed = 3]] closed, [[strategies.DIP_CONF_MILD.live.per_trade = +47.4]] per trade,
  ...
  t vs control [[strategies.DIP_CONF_MILD.live.t_vs_control = +0.93]].
...
## Healthy
Court standing: [[strategies.DIP_CONF_MILD.court.standing = 3/8 live virgin days vs control - HOLD]]. Mild days are a minority of the
