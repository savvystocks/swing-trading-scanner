# Treasurer + macro brake (Phase 4, SHADOW) - harvest_20260904_2130
...
- empirical mean win +0.500 / mean loss -0.429  (payoff ratio 1.17)
...
## Macro circuit brake
- rows where the macro brake WOULD have fired: 1207 of 25279 (4.8%)  [VIX>= 32 or +20% spike]
- shadow only: records would-have-braked; arms live only through LIVE_GATE + Governor.

- trials counted (council pass): {'council_features_clustered_out': 29, 'council_rule_folds': 5, 'council_member_fits': 25, 'TOTAL': 59}
