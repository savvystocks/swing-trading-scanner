# Treasurer + macro brake (Phase 4, SHADOW) - harvest_20260909_2130
...
- empirical mean win +0.501 / mean loss -0.431  (payoff ratio 1.16)
...
## Macro circuit brake
- rows where the macro brake WOULD have fired: 1207 of 25656 (4.7%)  [VIX>= 32 or +20% spike]
