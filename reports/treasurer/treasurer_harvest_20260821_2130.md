# Treasurer + macro brake (Phase 4, SHADOW) - harvest_20260821_2130
...
- empirical mean win +0.513 / mean loss -0.437  (payoff ratio 1.18)
...
## Macro circuit brake
- rows where the macro brake WOULD have fired: 590 of 19517 (3.0%)  [VIX>= 32 or +20% spike]
