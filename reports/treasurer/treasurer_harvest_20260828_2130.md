# Treasurer + macro brake (Phase 4, SHADOW) - harvest_20260828_2130
...
- empirical mean win +0.505 / mean loss -0.435  (payoff ratio 1.16)
...
## Macro circuit brake
- rows where the macro brake WOULD have fired: 975 of 22449 (4.3%)  [VIX>= 32 or +20% spike]
