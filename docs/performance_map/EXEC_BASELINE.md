...
## Numbers
- live: [[strategies.EXEC_BASELINE.live.n_closed = 49]] closed, [[strategies.EXEC_BASELINE.live.per_trade = +0.3]] per trade,
  win [[strategies.EXEC_BASELINE.live.win = 41%]], best trade removed [[strategies.EXEC_BASELINE.live.best_removed_per_trade = -6.9]],
  day mean [[strategies.EXEC_BASELINE.live.unit_mean = +5.0]] over [[strategies.EXEC_BASELINE.live.units = 22]] days,
  halves [[strategies.EXEC_BASELINE.live.h1 = +30.9]] / [[strategies.EXEC_BASELINE.live.h2 = -21.0]], dollars [[strategies.EXEC_BASELINE.live.total_usd = +1,476]].
- archive (pool): [[strategies.EXEC_BASELINE.archive.per_day = -5.2]] per day over [[strategies.EXEC_BASELINE.archive.days = 482]] days,
  halves [[strategies.EXEC_BASELINE.archive.h1 = -4.5]] / [[strategies.EXEC_BASELINE.archive.h2 = -5.8]].
