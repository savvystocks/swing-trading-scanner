...
| 15 | THE CORE STRATEGY — systematic index premium selling (CBOE PUT/WPUT methodology, BXMD sibling): the only options strategy with a 29.5-year academic study, a 30-year Wilshire study, a live index record, a live net-of-fees ETF, independent practitioner backtests, and our own market check all agreeing. Judged by premium-capture + rolling risk-adjusted vs SPX, NEVER by bull-month horse race (pre-registered). Free methodology, free validation, free execution. | ratify as the system's core strategy | CORE_STRATEGY_2026-08-02.md |
