...
This is an income engine, built to fund freedom — pursued with professional patience: small real capital first to prove survival, scaled only on evidence, aggressive once earned. One strategy, perfected, not a platform (amended v1.5: a regime portfolio of 2–4 proven strategies, each earning its seat through the full ladder individually). The machinery outlives any strategy — if the current signals prove empty, the harness stays and hunts new ones. The owner is not a spectator: five-plus hours a week in the workshop, every event on his phone, learning the concepts as deeply as the system does. Power flows to the brain only as its track record justifies, and never by drift. (v1.6: a second ambition stands behind the first — once proven, the system becomes the foundation of a subscription community whose income feeds the same pot; prove first, product second.)
...
- 2026-09-06 — v1.5: LADDER MECHANICS (owner, eight decisions in session, same night as v1.4). FUEL: a £500/month drip accumulates in a ladder reserve, deployable only up to the current rung's ceiling — idle reserve never enters positions early; rung gates also unlock fresh deposits. PROFITS: fully reinvested to the pot; no draws before £100k. PORTFOLIO: ambition amended from "one strategy perfected" to a REGIME PORTFOLIO of 2–4 proven strategies (bull, mild, bear, weekly income), each passing the full ladder individually — no strategy rides another's evidence; the earlier multi-strategy non-goal is superseded by this clause. PATIENCE: no calendar deadline judges the project; a written owner review fires on evidence only — every priority strategy's backtest edge falling below its live confidence bound, or discovery paper tuition exceeding $5,000 in a calendar month (a review conversation, never a halt; probes stay uncapped per the 2026-08-23 rule). HALT SCHEDULE: −30% through the £10k rung, −20% from the £20k rung upward; P(halt) recomputed at every rung. SELF-FUNDING: explicitly not a gate — the data bill is the cost of the hunt at every scale.
- 2026-09-06 — v1.6: FINAL GOAL-SPACE DECISIONS (owner, seven decisions, closing the ambition brainstorm). BEAR POSTURE: pre-registered discipline — in confirmed BEAR regimes proven bear strategies trade exactly their laddered size, no boost ever; the archive's bear edge is episode-clustered and the ladder does not bend to the most tempting tape. FIRST PROOF SEAT: first strategy to promote wins it, regardless of regime — evidence chooses, not preference. RUNG BAR: a quarter must return ≥ +5% on the staked rung inside drawdown bounds to double the ceiling; breakeven holds the rung; a failed 8-week proof stint returns the strategy to court for a fresh case and the seat opens to the next promoted candidate. OWNER ROLE AT CRUISE: the machine trades, culls, promotes to Proof and reports autonomously; the owner's permanent duties are signing every rung (no ceiling ever rises without his signature) and one weekly report — about an hour a week; hands-on rhythm continues until cruise is earned. MILESTONE TELEGRAMS (all chosen): first-ever promotion, every proof-week close and every rung earned, real-money drawdown warnings at −10% and −20%, and the first real fill; wired in with the Proof-account build. LEARNING: a weekly ten-minute plain-English lesson inside the weekly report, tied to what the system actually did that week. SECOND AMBITION — THE PRODUCT: a subscription service and community built on the proven system is a stated goal, its income feeding the same compounding pot; preparation (audit-grade track record, provenance, exportable performance history) is a standing requirement served by existing discipline, but nothing is sold, shared, or built as a service before the system is proven on the Proof account and the owner signs the start in writing. Prove first, product second.
