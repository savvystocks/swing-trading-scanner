CATALYST_TIERS = {
    ...
    "capex_echo": {"tier": "A", "points": 4.5, "label": "Hyperscaler capex echo (named customer) - TECH PRIORITY", "direction": "bull", "event_timing": "ongoing"},
    ...
    "ai_deal_announcement": {"tier": "S", "points": 5.0, "label": "AI/cloud deal w/ hyperscaler (NVDA/MSFT/META/AMZN partner) - TECH PRIORITY", "direction": "bull", "event_timing": "post_event"},
    "semis_capex_signal": {"tier": "A", "points": 4.5, "label": "Semis capex cycle signal (TSM/AMAT/LRCX guide-up) - TECH PRIORITY", "direction": "bull", "event_timing": "ongoing"},
